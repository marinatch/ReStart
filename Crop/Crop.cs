...
{
    //trees need 3 actions, parsnip neads 1....
    ...
    public void HarvestCrop(bool isUsingToolRight, bool isUsingToolUp, CropDetails cropDetails, GridPropertyDetails gridPropertyDetails, Animator animator)
    {
        ...
        {
            // Disable any box colliders, so the player won't get pushed by the harvested crops sprites
    ...
    //check if the current animation is Harvested -> stop
    ...
    public void HarvestActions(CropDetails cropDetails, GridPropertyDetails gridPropertyDetails)
    {
    ...
    private void SpawnHarvestedItems(CropDetails cropDetails)
    {
        ...
        for (int i = 0; i < cropDetails.cropProducedItemCode.Length; i++)
        {
            ...
            {
                cropsToProduce = Random.Range(cropDetails.cropProducedMinQuantity[i], cropDetails.cropProducedMaxQuantity[i] + 1); //+1 to include the max quantaty, if not it will be one value less
            }
