...
public class GridCursor : MonoBehaviour
{
        ...
        switch (itemDetails.itemType)
        {
            case ItemType.Hoeing_tool:
                if (gridPropertyDetails.isDiggable == true && gridPropertyDetails.daysSinceDug == -1)
                {
                    ...
                    //A methode that helps look if there are any items with colliders on, and if there are it passes them into the itemList 
    ...
    {
        //Converting the cursor pos. into a pixel adjusted pos.
    ...
    { 
        //it is needed in order to get to the left bottom corner of the grid cell
