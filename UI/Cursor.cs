...
public class Cursor : MonoBehaviour
{
    ...
    private void SetCursorValidity(Vector3 cursorPosition, Vector3 playerPosition)
    {
        ...
        // Check use radius corners //PDF 12_52
        ...
        // Check item use radius is valid   //PDF 12_52
        ...
        // Get selected item details fro the InventoryManager
    ...
    {
        //Converting screenPos into a worldPos
    ...
    /// <summary>
    /// Transforms the mousePos., using the screenPos. and the canvas, to a pixel point and it returns a Vector2, which is the pixel location.
    /// </summary>
    /// <returns></returns>
