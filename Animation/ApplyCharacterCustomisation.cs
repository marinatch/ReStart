...
public class ApplyCharacterCustomisation : MonoBehaviour
{
    ...
    //to know the position of the shirt
    ...
    private void ProcessGender()
    {
        ...
        // Get base pixels from a texture and populate it in the Color array
    ...
    private void AddShirtToTexture(int shirtStyleNo)
    {
        ...
        int x = (shirtStyleNo % shirtStylesInSpriteWidth) * shirtTextureWidth; //the % modulus, helps to define wich column
