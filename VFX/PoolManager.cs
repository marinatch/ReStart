...
{
    //the Key is the prefabs instance Id(int)
    ...
    {
        //GetInstanceID() is a methode from UnityEngine that returns the instance id of the object.
    ...
    {
        // Dequeue(): create a front GameObject from the Queue
