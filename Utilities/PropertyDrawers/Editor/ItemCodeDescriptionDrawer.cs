...
public class ItemCodeDescriptionDrawer : PropertyDrawer
{
    ...
    //this is the method that will draw the added fields in the Inspector
    ...
    private string GetItemDescription(int itemCode)
    {
        ...
        so_itemList = AssetDatabase.LoadAssetAtPath("Assets/ScriptableObjectsAssets/Item/so_ItemList.asset", typeof(SO_ItemList)) as SO_ItemList;

        List<ItemDetails> itemDetailsList = so_itemList.itemDetails;
        //Query the itemDetailsList where it exists----> find X's iteme code
