...
public class AnimationParameterControl : MonoBehaviour
{
    ...
    {
        //Subscribe the SetAnimationParameters method when an Animator calls it
        EventHandler.MovementEvent += SetAnimationParameters;
    }

    private void OnDisable()
    {
        //Unsubscribe the SetAnimationParameters method when an Animator calls it
        EventHandler.MovementEvent -= SetAnimationParameters;
    }
    ...
    {
        //Trigger the animation parameters
        ...
        //Trigger the corresponding parameter to the movment event 
        if (isUsingToolRight)
    ...
    {
        AudioManager.Instance.PlaySound(SoundName.effectFootstep);
    }
}
